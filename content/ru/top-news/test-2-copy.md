...
img = "images/top.jpg"
tags = ["tag1"]
title = "Аналитики прогнозируют крах одной из самых популярных криптовалют TEST 2-(copy)"
top = "1"
...
Более 50 процентов авторитетных аналитиков, опрошенных компанией Finder, уверены, что шуточную криптовалюту Dogecoin ждет крах в ближайшие четыре года.
Как оказалось, большинство криптовалютных аналитиков считают, что токен Dogecoin (DOGE) обречен на провал, согласно недавнему опросу.
